...
draw_text(text_x, 325, "If your Health drops to zero, or if your Suspicion gets too high, it'll be game over.");
//draw_text(683, 400, " ");
//draw_text(683, 250, "Collect all the clues and take them to the police to prove who the real killer is.");
draw_text(text_x, 375, "Be careful of going into houses while the police are nearby, you may just catch their attention." );
draw_text(text_x, 400, "If Police chasing after you manage to catch you, your Suspicion will raise even higher.");
draw_text(text_x, 425, "If the cops lose you out of their site they will give up thier search");
...
draw_text(text_x, 475, "Find the killer's cloak to make cop's view distance smaller, but it will make your suspicion bar raise faster");
