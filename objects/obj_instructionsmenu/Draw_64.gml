...
draw_text(text_x, 250, "Search the houses and rooms for items that could help you avoid the police and any Clues that will prove your innocence.");
...
draw_text(text_x, 475, "If the cops lose you out of their sight they will give up thier search.");
